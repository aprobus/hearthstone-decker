...
describe Card do
  describe 'Validations' do
    ...
    it 'should allow valid card types' do
      ['minion', 'spell', 'weapon'].each do |card_type|
        card = Card.new(:name => 'Ancient of Lore', :card_text => 'Text', :card_type => card_type, :mana => 2, :health => 2)
  ...
  describe 'Relations' do
    it 'should have a hero' do
      ...
      card = Card.new(:name => 'Ancient of Lore', :card_text => 'Text', :card_type => 'minion', :mana => 2, :health => 2)
